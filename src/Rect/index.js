      ...
      >
        {
          rotatable &&
          <React.Fragment>
          <div className="rotate rotatetl" onMouseDown={this.startRotate}>
          ...
          <div className="rotate rotatetr" onMouseDown={this.startRotate}>
            <svg width="10" height="10" viewBox='0 0 14 14' xmlns="http://www.w3.org/2000/svg">
              <path
                d="M10.536 3.464A5 5 0 1 0 11 10l1.424 1.425a7 7 0 1 1-.475-9.374L13.659.34A.2.2 0 0 1 14 .483V5.5a.5.5 0 0 1-.5.5H8.483a.2.2 0 0 1-.142-.341l2.195-2.195z"
                fill="#598DFA"
          ...
          <div className="rotate rotatebl" onMouseDown={this.startRotate}>
            <svg width="10" height="10" viewBox='0 0 14 14' xmlns="http://www.w3.org/2000/svg">
              <path
                d="M10.536 3.464A5 5 0 1 0 11 10l1.424 1.425a7 7 0 1 1-.475-9.374L13.659.34A.2.2 0 0 1 14 .483V5.5a.5.5 0 0 1-.5.5H8.483a.2.2 0 0 1-.142-.341l2.195-2.195z"
                fill="#598DFA"
          ...
          <div className="rotate rotatebr" onMouseDown={this.startRotate}>
            <svg width="10" height="10" viewBox='0 0 14 14' xmlns="http://www.w3.org/2000/svg">
              <path
                d="M10.536 3.464A5 5 0 1 0 11 10l1.424 1.425a7 7 0 1 1-.475-9.374L13.659.34A.2.2 0 0 1 14 .483V5.5a.5.5 0 0 1-.5.5H8.483a.2.2 0 0 1-.142-.341l2.195-2.195z"
                fill="#598DFA"
